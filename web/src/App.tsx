  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-black text-black dark:text-white">
      <header className="flex justify-between items-center">
        <h1 className="pt-4 pb-4 pl-4 pr-1 font-mono text-4xl sm:text-5xl ">LHR NET</h1>
        <label className="inline-flex items-center cursor-pointer pl-2 pr-4 pt-4 pb-4">
          {/* Based on an example from https://flowbite.com/docs/forms/toggle/ */}
          <span className="px-1 sm:px-3 text-md font-mono text-gray-900 dark:text-gray-300">STATS-FOR-NERDS</span>
